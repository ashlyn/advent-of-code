...
export async function p2020day11_part1(input: string): Promise<string | undefined> {
  return 'Not implemented';
}

export async function p2020day11_part2(input: string): Promise<string | undefined> {
  return 'Not implemented';
}
