...
export async function p2020day17_part1(input: string): Promise<string | undefined> {
  return 'Not implemented';
}

export async function p2020day17_part2(input: string): Promise<string | undefined> {
  return 'Not implemented';
}
