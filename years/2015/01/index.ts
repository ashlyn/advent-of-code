...
// solution path: /Users/ashlyn.slawnyk/workspace/advent-of-code/years/2015/01/index.ts
// data path  : /Users/ashlyn.slawnyk/workspace/advent-of-code/years/2015/01/data.txt
// problem url : https://adventofcode.com/2015/day/1

export async function p2015day1_part1(input: string): Promise<number | undefined> {
  let currentFloor = 0;
...
export async function p2015day1_part2(input: string): Promise<number | undefined> {
  let currentFloor = 0;
  for (let i = 0; i < input.length; i++) {
    if (input[i] === '(') currentFloor++;
    else currentFloor--;
