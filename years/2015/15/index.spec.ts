import { p2015day15_part1, p2015day15_part2 } from '.';
...
describe('2015 Day 15', () => {
  describe('Part 1 Solution', () => {
    ...
    part1Tests.forEach(testCase => {
      it(`${testCase.description}`, async () => {
        const actual = String(await p2015day15_part1(testCase.input));
  ...
  describe('Part 2 Solution', () => {
    ...
    part2Tests.forEach(testCase => {
      it(`${testCase.description}`, async () => {
        const actual = String(await p2015day15_part2(testCase.input));
        expect(actual).toEqual(testCase.expected);
      });
    });
  });
